...
namespace Can.Blog.Migrations
{
    ...
    [Migration("20230905190814_TenantRelatedThingsDeleted")]
    partial class TenantRelatedThingsDeleted
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Can.Blog.Blog.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Can.Blog.Blog.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Can.Blog.Blog.PostTag", b =>
                {
            ...
            modelBuilder.Entity("Can.Blog.Blog.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Can.Blog.Blog.Post", b =>
                {
                    b.HasOne("Can.Blog.Blog.Category", "Category")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("Can.Blog.Blog.PostTag", b =>
                {
                    b.HasOne("Can.Blog.Blog.Post", "Post")
                        .WithMany("PostTags")
                        .HasForeignKey("PostGuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Can.Blog.Blog.Tag", "Tag")
                        .WithMany("PostTags")
